...
<template>
  <div>
    ...
    <div id="select">
      <el-row>
        <el-col class="search-row">
          <el-input placeholder="请输入服务名称" class="input-select" v-model="routeId">
            <el-button slot="append" icon="el-icon-search" @click="search()"></el-button>
          </el-input>
        </el-col>
        <el-button type="primary" id="button" @click="newconfig()">新增配置</el-button>
      </el-row>
    </div>
    <el-table :data="route_id" style="width: 100%" border id="table1">
      ...
      <el-table-column prop="client" label="是否进行心跳检测"> </el-table-column>
